...
public class NBTCompound_1_13_R1 extends NBTCompound {
    private NBTCompound decode(NBTTagCompound c){
        NBTCompound w = new NBTCompound_1_13_R1();
        if (c != null) {
    ...
    public NBTCompound_1_13_R1() {
        super();
    }

    public NBTCompound_1_13_R1(NBTTagCompound c){
