...
public class Anvil_1_9_R1 extends AnvilWrapper<Anvil_1_9_R1> {
   private class Container extends ContainerAnvil {
    ...
    public Anvil_1_9_R1(Player player) {
        this.player = ((CraftPlayer) player).getHandle();
    }

    @Override
    public Anvil_1_9_R1 open() {
    ...
    @Override
    public Anvil_1_9_R1 setItem(AnvilSlot slot, ItemStack item) {
