...
public class NBTCompound_1_8_R1 extends NBTCompound {
    private NBTCompound decode(NBTTagCompound c){
        NBTCompound w = new NBTCompound_1_8_R1();
        if (c != null) {
            for(Object o : c.c()){
                String s = o.toString();
    ...
    protected void fromEntity(Entity entity) {
        net.minecraft.server.v1_8_R1.Entity ce = ((CraftEntity) entity).getHandle();
