        ...
        try {
            ...
            if(GameVersion.is1_13Above()){
                ...
                if(GameVersion.getVersion().equals(GameVersion.v1_13_R2)){
                    Class<?> IRegistryClass = Class.forName("net.minecraft.server." + v + ".IRegistry");
                    Object particles = ReflectionUtils.getStaticField("PARTICLE_TYPE", IRegistryClass);
                    particle = ReflectionUtils.getMethod("get", IRegistryClass, particles, new Group<>(
                    ...
                    particle = ReflectionUtils.getMethod("get", registryMaterialClass,
