...
public class NBTCompound_1_11_R1 implements NBTCompoundWrapper {
    private LinkedHashMap<String, Object> map = new LinkedHashMap<>();

    private NBTCompoundWrapper decode(NBTTagCompound c){
        NBTCompoundWrapper w = new NBTCompound_1_11_R1();
        if (c != null) {
            for(Object o : c.c()){
                String s = o.toString();
    ...
    public NBTCompound_1_11_R1() {
        super();
    }

    public NBTCompound_1_11_R1(NBTTagCompound c){
